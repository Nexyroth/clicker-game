...
// log10 của 1 BigNum, trả về Number thường - luôn AN TOÀN dù a cực lớn, vì log10 của 1 số dù to đến
// đâu cũng chỉ là exponent + log10(mantissa), một số nhỏ. Dùng cho các phép tính cần "đảo ngược" luỹ
// thừa (ví dụ: tính số lượng tối đa có thể mua hàng loạt dựa trên tiền hiện có).
export function log10(a) {
  if (isZero(a) || a.m < 0) return -Infinity;
