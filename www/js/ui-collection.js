...
import { isEquipped, equipItem, unequipItem, autoEquipBest } from "./collection.js";
...
// Gắn 1 listener DUY NHẤT (nút nằm ngoài danh sách nên không bị vẽ lại, không lo trùng listener)
elements.autoEquipButton.addEventListener("click", () => {
