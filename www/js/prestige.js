...
import { getItemBuffMultiplier } from "./items.js";
import {
  gemUpgrades,
  critUpgrades,
...
// Hệ số nhân từ Thành Tựu đã mở khoá - mỗi cái +0.5% (áp dụng cả Hệ Số Nhân lẫn Nexyroth/giây),
// biến Thành Tựu thành buff thật thay vì chỉ để ngắm.
export function getAchievementBonus() {
  return 1 + Object.keys(state.achievements).length * ACHIEVEMENT_BONUS_PER_UNLOCK;
}

// Hệ Số Nhân gốc x buff Cửa Hàng Đá Quý x Cây Kỹ Năng x Bộ Sưu Tập x Combo x Cuồng Nhiệt x Thuốc Bội Tăng
