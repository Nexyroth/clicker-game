...
export const effects = {
  ...
  goldenBuffEndTime: 0,
  recentClickTimestamps: [], // dùng tính kỷ lục "số lần click nhiều nhất trong 10 giây" - không lưu save
};
...
export const bossFight = {
  ...
  tier: null, // { id, namePrefix, hpMultiplier, rewardMultiplier, barColorClass, hpFillColorClass } - xem BOSS_TIERS trong data.js
  image: null, // đường dẫn ảnh Boss theo tên, null/ảnh lỗi thì UI tự fallback về icon 💀
  isMilestone: false, // Boss Trùm (mỗi 10 cấp) - thưởng nhân thêm, tên/ảnh riêng
