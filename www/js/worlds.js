...
export function getPetBossDamageBonus() {
  return getPetEffectSum("bossDamageBoost");
}
export function getPetItemDropBonus() {
  return getPetEffectSum("itemDropRateBoost");
}
export function getPetDiamondDropBonus() {
  return getPetEffectSum("diamondDropBoost");
}
export function getPetOfflineEfficiencyBonus() {
  return getPetEffectSum("offlineEfficiencyBoost");
}
